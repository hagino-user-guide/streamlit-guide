    ...
    html = """
        ...
        <head>
            ...
            <style>
                /* ── 全体ベーススタイル ── */
                html, body {
                    margin: 0; padding: 0; height: 100vh; background-color: #E2E8F0;
                ...
                .app-wrapper {
                    width: 100%; max-width: 430px; background-color: #FFFFFF; height: 100vh;
                ...
                /* ── 後続パーツのスタイル（変更なし） ── */
                .app-scroll-body { flex: 1; overflow-y: auto; -webkit-overflow-scrolling: touch; padding: 8px 16px 60px 16px; box-sizing: border-box; background-color: #FFFFFF; display: flex; flex-direction: column; width: 100%; position: relative; z-index: 10; }
                ...
                .floating-top-btn { position: absolute !important; bottom: 20px !important; right: 20px !important; width: 50px !important; height: 50px !important; border-radius: 25px !important; background: #005bac !important; color: white !important; display: flex !important; flex-direction: column !important; align-items: center !important; justify-content: center !important; box-shadow: 0 4px 16px rgba(0,0,0,0.2) !important; cursor: pointer !important; z-index: 9999 !important; border: none !important; }
            ...
            <script>
                function initApp() {
                    ...
                    if (floatTopBtn && kitchenSink) {
                        floatTopBtn.addEventListener('click', function() { kitchenSink.scrollTop = 0; });
                    }
